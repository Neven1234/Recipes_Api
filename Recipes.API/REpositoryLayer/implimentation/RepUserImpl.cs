...
{
    public class RepUserImpl<T> : IRepUser<T> where T : User
    {
        private readonly RecipeDbContext _dbContext;
        private readonly DbSet<T> entities;
        private readonly UserManager<IdentityUser> _userManager;
        private readonly IConfiguration _configuration;
        public RepUserImpl(RecipeDbContext dbContext, UserManager<IdentityUser> userManager, IConfiguration configuration)
        {
        ...
        public  string LogIn(T user)
        {
            try 
            {
                ...
                if (userr != null)
                {
                    ...
                    return "Log in successfully  , Token is" + token + "  expired in:" + expiration;
                }
                else
                {
